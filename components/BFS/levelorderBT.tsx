...
const LevelOrderTraversalVisualization = () => {
    ...
    const animateLevelOrder = async (root: TreeNode | null) => {
        if (!root) return;
    ...
    return (
        <Card className="w-full max-w-auto bg-slate-900 text-white">
            <CardHeader className="border-b border-slate-800">
                <CardTitle className="text-blue-400">Binary Tree Level-Order Traversal</CardTitle>
            </CardHeader>
...
export default LevelOrderTraversalVisualization;
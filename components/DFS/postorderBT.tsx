...
const PostorderTraversalVisualization = () => {
    ...
    const animatePostorder = async (node: TreeNode | null) => {
        if (!node) return;
    ...
    return (
        <Card className="w-full max-w-auto bg-slate-900 text-white">
            <CardHeader className="border-b border-slate-800">
                <CardTitle className="text-blue-400">Binary Tree Postorder Traversal</CardTitle>
            </CardHeader>
...
export default PostorderTraversalVisualization;
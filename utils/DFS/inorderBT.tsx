...
export const Theory = () => {
    return (
        <div className="space-y-6 p-6 max-w-3xl">
            <h2 className="text-2xl font-semibold">Theory: Inorder Traversal in a Binary Tree</h2>

            <p className="text-gray-700">
                Inorder traversal is a depth-first traversal method where we recursively visit the left subtree first,
                then visit the root node, followed by the right subtree. This method is particularly useful
                in scenarios where we need to process binary search trees as it visits nodes in ascending order.
            </p>
            ...
            <div>
                ...
                <ul className="list-disc pl-6 space-y-2">
                    ...
                    <li><span className="font-semibold">Root Second:</span> Visit the root node</li>
                    <li><span className="font-semibold">Right Last:</span> Recursively traverse the right subtree</li>
                </ul>
            </div>
...
Step 3: Visit 4 (no left child)
Step 4: Backtrack to 2, visit 2
Step 5: Visit 5 (right child of 2)
Step 6: Backtrack to 1, visit 1
Step 7: Move to right subtree, visit 3
Step 8: Visit 6 (right child of 3)`}
                    </pre>
                    <p className="mt-4">
                        <span className="font-semibold">Inorder Traversal Output: </span>
                        <span className="font-mono">4 → 2 → 5 → 1 → 3 → 6</span>
                    </p>
                </div>
            </div>
        </div>
    ...
    return (
        <div className="space-y-4">
            ...
            <ul className="space-y-2">
                <li>
                    <a
                        href="https://leetcode.com/problems/binary-tree-inorder-traversal/description/"

...
import { Theory, CodeSnippet, Practice, Complexity } from "@/utils/DutchNationalFlag/Sort0s1s2s";
import { Card, CardHeader, CardTitle, CardContent } from "@/components/ui/card";
import { motion } from "framer-motion";
import { BookOpen, Code, Brain, TrendingUp } from "lucide-react";
import DutchNationalFlagAnimationsortarray from "@/components/DutchNationalFlag/Sort0s1s2s";


const DutchNationalFlagPage = () => {
                ...
                <div className="relative container mx-auto px-6 py-16">
                    <div className="max-w-3xl mx-auto text-center">
                        <motion.h1
                            ...
                            className="text-5xl font-bold mb-10 bg-gradient-to-r from-blue-400 to-violet-400 bg-clip-text text-transparent"
                        >
                    ...
                    <Card className="mb-16 bg-slate-900/50 border-slate-800 shadow-2xl backdrop-blur-sm w-auto">
                        ...
                        <CardContent>
                            <div className="bg-slate-950/50 p-8 rounded-lg backdrop-blur-sm">
                                <DutchNationalFlagAnimationsortarray />
                            </div>
                        </CardContent>
                    </Card>
                </motion.div>
...
export default DutchNationalFlagPage;

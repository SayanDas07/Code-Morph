...
import { Theory, CodeSnippet, Practice, Complexity } from "@/utils/DFS/inorderBT";
import { Card, CardHeader, CardTitle, CardContent } from "@/components/ui/card";

import { motion } from "framer-motion";
import { BookOpen, Code, Brain, TrendingUp } from 'lucide-react';
import InorderTraversalVisualization from '@/components/DFS/inorderBT';

const InorderTraversalPage: React.FC = () => {
            ...
            <div className="relative bg-slate-900 border-b border-slate-800 overflow-hidden">
                ...
                <div className="relative container mx-auto px-6 py-16">
                    <div className="max-w-3xl mx-auto text-center">
                        ...
                        >
                            Inorder Traversal is a fundamental algorithm used to visit all nodes in a binary tree. Which follows the order of Left {'->'} Root {'->'} Right. 
                        </motion.p>
                    </div>
                </div>
            </div>

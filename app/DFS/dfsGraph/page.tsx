        ...
        <div className="relative container mx-auto px-6 py-16">
          <div className="max-w-3xl mx-auto text-center">
            ...
            >
              ...
              backtracking. It is a fundamental algorithm in graph theory and is
              used in various applications such as cycle detection, topological
              sorting, and solving puzzles.
            </motion.p>
          </div>
        </div>
      </div>

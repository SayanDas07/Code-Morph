...
import { Theory, CodeSnippet, Practice, Complexity } from "@/utils/DFS/postorderBT";
import { Card, CardHeader, CardTitle, CardContent } from "@/components/ui/card";

import { motion } from "framer-motion";
import { BookOpen, Code, Brain, TrendingUp } from 'lucide-react';
import PostorderTraversalVisualization from '@/components/DFS/postorderBT';
            ...
            <div className="relative bg-slate-900 border-b border-slate-800 overflow-hidden">
                ...
                <div className="relative container mx-auto px-6 py-16">
                    <div className="max-w-3xl mx-auto text-center">
                        ...
                        >
                            Post Order Traversal is a fundamental algorithm used to visit all nodes in a binary tree. Which follows the order of {'->'} Left {'->'} Right {'->'} Root. 
                        </motion.p>
                    </div>
                </div>
            </div>
                    ...
                    <Card className="mb-16 bg-slate-900/50 border-slate-800 shadow-2xl backdrop-blur-sm">
                        ...
                        <CardContent>
                            <div className="bg-slate-950/50 p-8 rounded-lg backdrop-blur-sm">
                                <PostorderTraversalVisualization />
                            </div>
                        </CardContent>
                    </Card>
                </motion.div>

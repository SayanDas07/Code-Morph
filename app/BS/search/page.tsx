...
import { Theory, CodeSnippet, Practice, Complexity } from "@/utils/BS/search";
...
import BinarySearchVisualizer from '@/components/BS/search';
            ...
            <div className="relative bg-slate-900 border-b border-slate-800 overflow-hidden">
                ...
                <div className="relative container mx-auto px-6 py-16">
                    <div className="max-w-3xl mx-auto text-center">
                        ...
                        >
                            Binary search is a fast search algorithm with run-time complexity of O(log n). This
                            algorithm works on the principle of divide and conquer. It is used to find the position of

...
import { Theory, CodeSnippet, Practice, Complexity } from "@/utils/BFS/bfsGraph";
            ...
            <div className="relative bg-slate-900 border-b border-slate-800 overflow-hidden">
                ...
                <div className="relative container mx-auto px-6 py-16">
                    <div className="max-w-3xl mx-auto text-center">
                        ...
                        >
                            Breadth First Search (BFS) is a fundamental graph traversal algorithm that explores all the vertices in the graph level by level. It is used to find the shortest path between two nodes or to visit all the nodes in a graph.
                        </motion.p>
                    </div>
                </div>
            </div>

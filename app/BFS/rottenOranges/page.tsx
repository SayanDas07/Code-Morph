...
import { Theory, CodeSnippet, Practice, Complexity } from "@/utils/BFS/rottenOranges";
import { Card, CardHeader, CardTitle, CardContent } from "@/components/ui/card";

import { motion } from "framer-motion";
import { BookOpen, Code, Brain, TrendingUp } from 'lucide-react';

import { RottingOrangesVisualizer } from '@/components/BFS/rottenOrangesGraph';
            ...
            <div className="relative bg-slate-900 border-b border-slate-800 overflow-hidden">
                ...
                <div className="relative container mx-auto px-6 py-16">
                    <div className="max-w-3xl mx-auto text-center">
                        ...
                        >
                            Breadth First Search (BFS) : Rotten Oranges : Min time to rot all oranges
                        </motion.h1>

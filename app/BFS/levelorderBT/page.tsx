...
import { Theory, CodeSnippet, Practice, Complexity } from "@/utils/BFS/levelorderBT";
import { Card, CardHeader, CardTitle, CardContent } from "@/components/ui/card";

import { motion } from "framer-motion";
import { BookOpen, Code, Brain, TrendingUp } from 'lucide-react';
import LevelOrderTraversalVisualization from '@/components/BFS/levelorderBT';

const LevelOrderBTpage: React.FC = () => {
            ...
            <div className="relative bg-slate-900 border-b border-slate-800 overflow-hidden">
                ...
                <div className="relative container mx-auto px-6 py-16">
                    <div className="max-w-3xl mx-auto text-center">
                        ...
                        >
                            Level order traversal is a popular tree traversal algorithm that visits each node in a tree level by level and prints the nodes at each level from left to right.
                        </motion.p>
                    </div>
                </div>
            </div>
                    ...
                    <Card className="mb-16 bg-slate-900/50 border-slate-800 shadow-2xl backdrop-blur-sm">
                        ...
                        <CardContent>
                            <div className="bg-slate-950/50 p-8 rounded-lg backdrop-blur-sm">
                                <LevelOrderTraversalVisualization />
                            </div>
                        </CardContent>
                    </Card>
                </motion.div>
...
export default LevelOrderBTpage;